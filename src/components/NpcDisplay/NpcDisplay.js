          ...
          <div className="traits">
            <div className="external-traits">
              <div className="appearance">
                <h4>Appearance</h4>
                <p>{`${selectedNpc.appearance.trait} - ${selectedNpc.appearance.detail}`}</p>
              </div>
            ...
            <div className="personality-traits">
              <h4>Personality</h4>
              <p>{`Alignment: ${selectedNpc.personality.alignment}`}</p>
              <p>{`Ideals: ${selectedNpc.personality.ideals}`}</p>
              <p>{`Bond: ${selectedNpc.personality.bond}`}</p>
              <p>{`Flaw: ${selectedNpc.personality.flaw}`}</p>
            </div>
          </div>
